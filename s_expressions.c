...
/* Add SYM and SEXPR as possible types */
...
/* Contruct pointer to a new Number lval */
...
/* Construct a pointer to a new Error val */
...
lval *lval_pop(lval *v, int i) {
  ...
  /* Decrease count of items is list */
  v->count--;
...
int main(int argc, char *argv[])
{
  ...
  puts("Lispish Version 0.0.0.0.5");
